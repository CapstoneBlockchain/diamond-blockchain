...
public class Controller implements Initializable {
    ...
    public void mainScreen_Deal() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("DealScreen_CheckOwner.fxml"));
    ...
    public void mainScreen_Stealed() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("StealedScreen_CheckOwner.fxml"));
            Parent parent = loader.load();
    ...
    public void dealScreen_CheckOwner_Lookup() {
        ...
        try {
            if (myDB.checkBasicOwner(basicOwnerID, basicOwnerDiamond)) {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("DealScreen_Popup_NOK.fxml"));
                Parent parent = loader.load();
    ...
    public void dealScreen_Popup_OK_OK() {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("DealScreen_RegisterNewOwner.fxml"));
            Parent parent = loader.load();
    ...
    public void dealScreen_RegisterNewOwner_Register() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("DealScreen_CheckNewOwner.fxml"));
            Parent parent = loader.load();
    ...
    public void dealScreen_CheckNewOwner_OK() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("DealScreen_Complete.fxml"));
            Parent parent = loader.load();
    ...
    public void stealedScreen_Complete_Complain(){
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("StealedScreen_Popup_OK.fxml"));
            Parent parent = loader.load();
