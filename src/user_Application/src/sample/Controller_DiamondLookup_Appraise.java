...
public class Controller_DiamondLookup_Appraise implements Initializable {
    @FXML
    ...
    @FXML
    private Button lookup_Appraise_ReturnButton;
    ...
    public void lookup_ReturnBack(ActionEvent actionEvent){
        try {
            ...
            Stage primaryStage = (Stage) lookup_Appraise_ReturnButton.getScene().getWindow();
            primaryStage.close();
